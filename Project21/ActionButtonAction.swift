//
//  ActionButtonAction.swift
//  Project21
//
//  Created by Jeff Huang on 2015-08-18.
...
public class ActionButton: NSObject {
    ...
    public init(attachedToView view: UIView, items: [ActionButtonItem]?) {
        ...
        self.floatButton.layer.shadowColor = UIColor(red:0.19, green:0.30, blue:0.43, alpha:1.0).CGColor
        self.floatButton.setImage(UIImage(named: "menu"), forState: .Normal)
        self.floatButton.backgroundColor = UIColor(red:0.23, green:0.35, blue:0.60, alpha:1.0)
