...
public class ActionButtonItem: NSObject {
    ...
    */
    public init(title optionalTitle: String?, image: UIImage?) {
        ...
        self.button.layer.cornerRadius = CGFloat(buttonSize.width / 2)
        self.button.setImage(UIImage(named: "delete"), forState: .Normal)
        self.button.backgroundColor = UIColor(red:0.90, green:0.38, blue:0.29, alpha:1.0)
